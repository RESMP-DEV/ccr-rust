...
ANTHROPIC_DEFAULT_FABLE_MODEL=zai-personal,glm-5.3 \
ANTHROPIC_DEFAULT_OPUS_MODEL=zai-personal,glm-5.3 \
ANTHROPIC_DEFAULT_SONNET_MODEL=zai-personal,glm-5.3 \
ANTHROPIC_DEFAULT_HAIKU_MODEL=zai-personal,glm-5.3 \
CLAUDE_CODE_SUBAGENT_MODEL=zai-personal,glm-5.3 claude
```
...
claude_suite() {
  ...
  env -u ANTHROPIC_API_KEY -u ANTHROPIC_AUTH_TOKEN -u ANTHROPIC_BASE_URL \
    ...
    -u ANTHROPIC_DEFAULT_OPUS_MODEL -u CLAUDE_CODE_SUBAGENT_MODEL \
